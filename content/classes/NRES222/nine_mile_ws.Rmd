...
Those lines look fine, but what if we want to know what the values of $c$ and $z$ actually are for each field? To do that we need the summary of the linear regressions shown in the graphs. 
