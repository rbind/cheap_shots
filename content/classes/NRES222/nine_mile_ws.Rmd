...
1) Using the graphs with the raw data, rank the 3 fields ( burned in 2015, 2016, or 2017) from most homogeneous (all student data sets similar) to most heterogeneous.  Why are some fields more variable (speculate)?

Now calculate the average number of species found in each size plot for each field.  Next, make a graph with the average numbers of species versus plot size for each field.
