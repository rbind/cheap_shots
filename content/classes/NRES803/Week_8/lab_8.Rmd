...
library(GGally)
library(gridExtra)
sheep = read.table("data/soaysheep.txt",header=TRUE)
...
```{r}
ozone <- read.table("data/ozone.data.txt", header=TRUE)
...
looks quite non-linear, as does radiation. Notice that Ozone readings are
bounded - they’re never less than zero, and the smallest value is 1.
