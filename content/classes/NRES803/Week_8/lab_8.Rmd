...
knitr::opts_chunk$set(echo = TRUE, tidy = TRUE, warning=FALSE, message=FALSE, results= 'markup', fig.show='asis', tidy.opts=list(arrow = TRUE, width.cutoff=60), include = FALSE)
```
...
pred_gam <- augment(sheep.gam, newdata=nd, se_fit = TRUE) %>%
  mutate(
