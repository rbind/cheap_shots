...
We could fit a seperate model to each subject and combine them. This is effectively a Subject*Days interaction model.
```{r, eval = lab.eval}
...
```{r TableCoeffcients, eval=lab.eval, echo=lab.eval}
...
step(mice.global, ddf = "Satterthwaite")
```
