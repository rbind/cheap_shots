...
```{r figureEarFootbySite, eval=-4, fig.cap='Ear length vs. foot length in mm at a number of sites in the Northwest of Nebraska for two species of deer mouse.'}
...
```{r globalModelSummary, eval=ifelse(lab.eval, TRUE, 1:3)}
...
```{r finalModelSummary, eval=ifelse(lab.eval,TRUE,1), result='hold'}
...
```{r, eval= ifelse(lab.eval,TRUE,1:2)}
