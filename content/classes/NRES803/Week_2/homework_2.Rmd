...
Please do the analyses yourself. Do not use the analysis presented in the paper, although you can refer to the paper for the ecological background. I WILL know if you do not do the analysis yourself! Please submit an R Markdown file named "yourlastname_hw_2.Rmd". You should be able to click the "knit" button in RStudio and have it produce an html file without errors.
...
Complete Homework and Submit by Midnight Tuesday of week 3.
