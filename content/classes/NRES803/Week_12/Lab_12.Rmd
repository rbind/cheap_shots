...
```{r}
ecervi = read.table("data/deerecervi.txt",header=TRUE)
ecervi <- ecervi %>%
...
bigBoot2 <- bootMer(M0, myFunc, nsim=1000,
                    parallel = "snow",
                    cl = cl)
