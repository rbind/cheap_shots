...
us_confirmed_total <- us_wide2long(jhu_confirmed) %>% 
...
us_by_state <- us_wide2long(jhu_confirmed) # see, fancy! 
...
us_by_state <- list(
  Confirmed = us_wide2long(jhu_confirmed), # see, fancy! 
  Deaths = us_wide2long(jhu_deaths),
  Recovered = us_wide2long(jhu_recovered)
) %>% 
