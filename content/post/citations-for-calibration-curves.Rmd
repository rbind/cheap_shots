...
But, I need to find a citation. In my brief search so far I found David Cox [(1958)](https://www.nuffield.ox.ac.uk/users/cox/cox49.pdf) wrote about this hypothesis for a binary regression model. That wasn't in the context of cross validation however. A brief look at Web of Science indicates that papers in clinical sciences are still citing it when they test models, so maybe that's good enough?
