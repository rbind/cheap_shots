...
features first. The y axis is now cases / 100,000 people to make it easier to compare Italy 
...
abbreviations to the state names in the state rows. So that took an hour. 
